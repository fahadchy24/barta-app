    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 justify-between">
            ...
            <form action="" method="POST"
                  ...
                  x-data="search()" @keydown.escape="open = false">
                <input
                    type="text"
                    x-model="query"
                ...
                <!-- Search Results -->
                <div x-show="open"
                     class="absolute top-12 mt-2 w-full bg-white shadow-lg border border-gray-300 rounded-lg z-50"
                     @click.away="open = false">
                    <template x-if="results.length > 0">
                        <ul>
                            <template x-for="result in results" :key="result.id">
                                <li class="p-2 hover:bg-gray-100 cursor-pointer">
                                    <a x-bind:href="`/user/${result.username}`">
                                        <span x-text="result.full_name"></span>
                                    </a>
                                </li>
                            </template>
                        </ul>
