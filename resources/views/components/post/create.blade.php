...
<form
    ...
    class="bg-white border-2 border-black rounded-lg shadow mx-auto max-w-none px-5 py-5 sm:px-6 space-y-3">
    @csrf
        ...
        <div class="flex justify-between items-baseline">
            <div class="flex gap-4 text-gray-600">
                ...
                <div x-data="{src :''}"
                    ...
                    <div>
                        <img :src="src" :class="src ? 'w-16 h-16 mt-2 mx-auto block' : 'hidden'" alt="">
                    </div>
                </div>
                <!-- /Upload Picture Button -->
            </div>
